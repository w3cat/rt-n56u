...
user_name="root"                                    # 用户名
user_password="toor"                                # 登录密码
lan_ip="10.7.2"                                 # LAN 地址 别写后面的 .1
#wlan_2g_ssid="HiWiFi-2.4G"                             # 2G 无线名称
#wlan_5g_ssid="HiWiFi-5G"                               # 5G 无线名称
#wlan_guest_2g_ssid="HiWiFi_pub_2.4G"                   # 2G 访客无线名称
#wlan_guest_5g_ssid="HiWiFi_pub_5G"                     # 5G 访客无线名称
wlan_2g_psk="7758521@Qq"                              # 2G WIFI密码最少8位 空白为不设置
